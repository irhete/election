...
public void doGet(HttpServletRequest req, HttpServletResponse resp)
	  ...
	  Connection c = null;
	    try {
	      ...
	      success.next();
	      Candidate candidate = new Candidate(success.getString("lastName"), success.getString("firstName"), Integer.parseInt(id), Data.areas[Integer.parseInt(success.getString("area"))-1], Data.parties[Integer.parseInt(success.getString("party"))-1], success.getString("description"), success.getString("picture"));
